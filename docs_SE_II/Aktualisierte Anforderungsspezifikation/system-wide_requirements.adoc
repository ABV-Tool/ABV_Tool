...
=== SWFA-2: Das System muss sicherstellen, dass die E-Mails ordentlich versendet werden.
Zur Überprüfung werden Anträge gestellt und geändert und der Mailcatcher überprüft, ob die Mail gesendet wurde.

=== SWFA-3: Das System muss sicherstellen, dass nur berechtigte Benutzer die Tagesordnung bearbeiten können.
...
=== SWFA-4: Das System muss sicherstellen, dass nur berechtigte Benutzer die Anträge bearbeiten können.
