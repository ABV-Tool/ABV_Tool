...
Die Ziele dieser Phase sind die Verfeinerung und Finalisierung des Entwurfes, die Implementierung der Use Cases und die Durchführung von Tests. 
...
* Umstrukturierung Front End in Komponenten
* UC 1 umsetzen
