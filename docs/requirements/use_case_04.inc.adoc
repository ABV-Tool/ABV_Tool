...
== Use-Case: UC04 Plenumssitzung vertagen
...
. System bindet die Tagesordnung der ausgewählten Sitzung samt Anträgen in die nächste Sitzung mit ein und makiert die Sitzung als "vertagt".
