...
NOTE: Die funktionalen Anforderungen, die sich aus der Interaktion von Nutzern mit dem System ergeben, sind als Use Cases in einem separaten link:use-case_model.adoc[Dokument] festgehalten.
...
==== NFAS-1: Das System soll einfach erweiterbar sein. Darunter zählt mitunter das Hinzufügen von neuen Funktionalitäten.
Zur Überprüfung 

==== NFAS-2: Das Hinzufügen von neuen Antragsarten sollte ohne großen Aufwand machbar sein.  
Zur Überprüfung
