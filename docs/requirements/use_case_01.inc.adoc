...
Wenn Antragsteller im Schritt 4 des Standardablauf auf "Antrag absenden" klickt und die nächste Plenumssitzung in weniger als einer Woche stattfindet, so wird er über die Verschiebung seines Antrags auf die übernächste Plenumssitzung informiert. 
