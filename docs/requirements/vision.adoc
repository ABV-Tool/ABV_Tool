...
| betrifft | alle Antragsteller, insbesondere aber das Präsidium
...
|StuRa als BeschlussorangOrdnungen des StuRa insb. Geschäftsordnung
|Der StuRa gibt sich im Rahmen seiner Selbstverwaltung 
|
...
* eher geringer Zeitaufwand, wenn man davon ausgeht, dass sich Antragsteller vorher inhaltlich mit seinem Anliegen beschäftigt hat und lediglich das Formular ausgefüllt werden muss
* bei ersten Antragstellungen ist Zeitaufwand höger, da Antragssteller sich noch mit dem Tool vertraut machen muss, wird dann geringer
* Antragsteller werden das Tool voraussichtlich als Webanwendung auf Rechnern verwenden
* Antragstellung erfolgt nur online und über das #HTW Netz#
...
* Es gibt einen festen Kreis an Personen im StuRa die für die Antragsverwaltung verantwortlich sind. Die Anzahl bleibt dabei im wesentlichen gleich und hat nur geringe Abweichungen.
...
*derzeit erfolgt 
*Die fertigen Beschlüsse sollen als PDF exportiert werden können.
...
* Export in PDF der fertigen Beschlüsse und Tagesordnungen
...
| Beschlüsse einpflegen | hoch | Änderung Antragstatus auf beschlossen, abgelehnt oder vertagt, Abstimmungsergebnis soll erfassst werden | SoSe 23
...
| Benutzeradministration | hoch | Vergabe eines Log-in für Antragsverwalter | SoSe 23
...
| Benachrichtigung Antragsteller über Antragseingang und -status | mittel | Der Antragsteller soll nach Antragseingang eine E-Mail mit Antrag und Antragsnummer zugesendet bekommen sowie eine E-Mail erhalten, wenn sich der Antragsstatus geändert hat | SoSe 23
