...
* #bisher wurde für das erstellen der Tagesordnung Pentapad (etherpad) verwendet -> wird von uns ins Tool integriert zur Erhöhung der Flexibilität#
...
| kein Java verwenden | Hoch | xx
| muss auf Unix/Linux laufen | Hoch | xx
| freie Lizenz benutzen (z.B. GPL, MIT, Apache) | Hoch | xx
| muss nach Anleitung selbst installierbar sein | Hoch | xx
