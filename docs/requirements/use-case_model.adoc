...
package Use-Cases {
    ...
    usecase "Benutzer administrieren" as UC5
}
AS --> UC1
AV --> UC2
AV --> UC6
...
Für die Darstellung der Sitzungsverwaltung haben wir uns entschieden ein Wireframe zu erstellen, da das am wenigsten klar war wie das ganze Aussehen soll. 

.Wireframe zu Sitzungsverwaltung 
