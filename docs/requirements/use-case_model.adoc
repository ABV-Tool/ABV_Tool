...
Nachfolgend werden die identifizierten Use Cases aufgelistet und näher bschrieben. Auch wird ein Use Case Diagramm eingefügt um die Gesamtübersicht zu verbessern.


== Identifizierte Use Cases
// Liste aller identifizierten Use Cases (priorisiert)
* *UC01*: Antrag stellen
* *UC02*: Tagesordnung erstellen/verwalten 
* *UC03*: Antrags-Beschlussfassung
* *UC04*: Tagesordnung verwalten
* *UC05*: Benutzeradministration 
* *UC06*: Download als PDF
* *UC07*: Sitzungen verwalten

#Bezeichnungen + Prio ist noch zu klären#
