...
Nachfolgend werden die identifizierten Use Cases (UC) aufgelistet und näher bschrieben. Auch wird ein Use Case Diagramm eingefügt um die Gesamtübersicht zu verbessern.
