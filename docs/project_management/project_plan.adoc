...
Das Team nutzt Open Up für die Organisation des Projektes. In allen Meetings wird Protokoll geführt, ein Teammitglied ist dafür verantwortlich, das restliche Team kontroliert dieses. Alle Änderungen und Vorhaben werden umgeht mit dem Kunden abgeklärt und durch diesen bestätigt. Unser Kunden Kontakt ist Theresa Minister.
...
| I1
|
* Kennlerenen und Rollenverteilung
