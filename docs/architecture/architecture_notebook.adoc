...
- Wir nutzen Django für das Frontend, da der Vorgänger dies dafür nutzte und bereits Erfahrungen in Python haben.
- Als
...
- (haben wir zumindest im Nachinein vor, damit auch englischsprachige Stundenten/Personen Anträge stellen können)

=== Scheduling 
- Anträge müssen zu einer gewissen Zeit vor der Plenumssitzung gestellt werden

=== Online-Hilfe 
- sofern wir genügend Zeit übrig haben, wollen wir Online ein Handbuch bereitstellen
