...
- Wir nutzen HTML für das Frontend, da der Vorgänger dies dafür nutzte und bereits Erfahrungen in Python haben.
- Als Backend nutzen wir eine Kombination aus DJango für die funktionalitäten und PostSQL für die Datenbank zu Speicherung der Daten.
...
Wir nutzen eine Drei-Schichten-Architektur. Dadurch können wir notwendige Anpassungen schnell und flexibel verwirklichen, da die einzelnen Schichten klar voneinander getrennt sind.
