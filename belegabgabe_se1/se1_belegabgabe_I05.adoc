...
// --- 2. Teammitglieder -----------------------
Marten Petters <marten.petters@htw-dresden.de>; Alexander Minukow <alexander.minukow@htw-dresden.de>; Göran Heinemann <goeran.heinemann@htw-dresden.de>; Xuan Huy Nguyen <xuanhuy.nguyen@htw-dresden.de>; Simon Voges <simon.voges@htw-dresden.de>; Max Patecky <max.patecky@htw-dresden.de>; Mirjam Müller <mirjam.mueller@htw-dresden.de>
// --- 3. Abgabedatum --------------------------
27. Januar 2023
// ---------------------------------------------
:docs: ../docs
...
include::{docs-requirements}/use-case_model.adoc[lines=1..1;6..-1,leveloffset=+1]
<<<
// System-wide Requirements
...
[#Antragsdaten]
include::{docs-requirements}/Antragsdaten.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
// Domänenmodell
